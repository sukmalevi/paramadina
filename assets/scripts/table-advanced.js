var TableAdvanced = function () {
    ...
    var initTable1 = function() {
        ...
        function fnFormatDetails ( oTable, nTr )
        {
            ...
            var sOut = '<table>';
			sOut += '<tr><td>Program Studi:</td><td>'+aData[1]+'</td>  <td>Jalur:</td><td>'+aData[3]+'</td> </tr>';
            sOut += '<tr><td>Periode:</td><td>'+aData[2]+'</td></tr>';
            sOut += '<tr><td>Buka Periode:</td><td>'+aData[4]+'</td></tr>';
			sOut += '<tr><td>Tutup Periode:</td><td>'+aData[5]+'</td></tr>';
            sOut += '</table>';
