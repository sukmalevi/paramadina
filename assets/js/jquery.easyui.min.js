...
if(col.width) col.width =parseFloat(col.width);
...
_677(this,q);
}},currentText:"Today",closeText:"Close",okText:" __.:Ok:.__ ",formatter:function(date){
...
$.fn.datetimebox.defaults=$.extend({},$.fn.datebox.defaults,{showSeconds:false,keyHandler:{up:function(){
},down:function(){
},enter:function(){
_68c(this);
},query:function(q){
