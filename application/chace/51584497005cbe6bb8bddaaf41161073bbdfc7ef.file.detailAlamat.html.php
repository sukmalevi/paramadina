<?php /* Smarty version Smarty-3.1.14, created on 2016-11-11 09:48:12
         compiled from "application/views/portal/detailAlamat.html" */ ?>
<?php /*%%SmartyHeaderCode:354767758535625d10cdb35-38772394%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '51584497005cbe6bb8bddaaf41161073bbdfc7ef' => 
    array (
  ...
  'nocache_hash' => '354767758535625d10cdb35-38772394',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_535625d118ffc6_15613255',
  'variables' => 
  array (
    'kode' => 0,
    'nama' => 0,
...
<?php if ($_valid && !is_callable('content_535625d118ffc6_15613255')) {function content_535625d118ffc6_15613255($_smarty_tpl) {?><form action="#" class="form-horizontal" id="form_sample_2" method="post">	
...
"><?php echo $_smarty_tpl->tpl_vars['alamat']->value->agama;?>
		 ...
		 <div class="form-body">
			<h3 class="form-section text-primary" style="margin-bottom: 15px; margin-left: 50px;margin-top: 12px;">Alamat Rumah & Surat
			</h3>	
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
...
" disabled id="fax">
		...
		<div class="form-body">
			<h3 class="form-section text-primary" style="margin-bottom: 15px; margin-left: 50px;margin-top: 12px;">Alamat Surat
			</h3>	
			<div class="row">
				<div class="col-md-6">
					<div class="form-group">
