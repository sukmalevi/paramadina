<?php /* Smarty version Smarty-3.1.14, created on 2016-11-11 09:48:10
         compiled from "application/views/portal/detailKeluarga.html" */ ?>
<?php /*%%SmartyHeaderCode:41550421535625d3db91d3-91763081%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '096807d665391317fcbf9b5db54bdc1c6cc50f08' => 
    array (
  ...
  'nocache_hash' => '41550421535625d3db91d3-91763081',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_535625d3eba995_00487432',
  'variables' => 
  array (
    'kode' => 0,
    'ortu' => 0,
...
<?php if ($_valid && !is_callable('content_535625d3eba995_00487432')) {function content_535625d3eba995_00487432($_smarty_tpl) {?><form action="#" class="formOrtu form-horizontal" id="form_sample_2" method="post">	
	 <div class="form-body" style="font-size:bold">
			<h3 class="form-section text-primary" style="margin-bottom: 15px; margin-left: 50px;margin-top: 12px;">DATA ORANG TUA/ WALI <span style="font-size: 14px" class="text-danger">*pilih salah satu untuk diisi</span>
			...
			<div id="detailKel">	 
			<div class="col-md-12">
					<div style="background-color:#555555;color:#FFFFFF;margin-bottom:7px;-moz-border-start-style: groove;height: 30px;">
