<?php /* Smarty version Smarty-3.1.14, created on 2017-08-10 10:37:07
         compiled from "application/views/portal/kontenDaftarUlangPasca.html" */ ?>
<?php /*%%SmartyHeaderCode:258656394598bd4e3168cf4-18737571%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd20cc141c2cefe8e49ef1e63f97e17538af630e2' => 
    array (
      0 => 'application/views/portal/kontenDaftarUlangPasca.html',
      1 => 1502177295,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '258656394598bd4e3168cf4-18737571',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_598bd4e33499e3_25430333',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_598bd4e33499e3_25430333')) {function content_598bd4e33499e3_25430333($_smarty_tpl) {?><script type="text/javascript" src="<?php echo $_smarty_tpl->tpl_vars['host']->value;?>
 ...
 x Rp <font class="biaya"><?php echo $_smarty_tpl->tpl_vars['biaya']->value->biayaPerSks;?>
                        ...
                        <?php }else{ ?>                        
                            <a class="man list-group-item">
                                    ...
                                    <label>
                                            : Rp <font class="biaya"><?php if (isset($_smarty_tpl->tpl_vars['diskonVal']->value)){?><?php echo $_smarty_tpl->tpl_vars['diskonVal']->value;?>
<?php }?></font>
                                             <?php if ($_smarty_tpl->tpl_vars['jalur']->value=='F1'){?>   (Fellowship 100%)<?php }?>
                                             <?php if ($_smarty_tpl->tpl_vars['jalur']->value=='F2'){?> (Fellowship 25%)<?php }?>
                                             <?php if ($_smarty_tpl->tpl_vars['jalur']->value=='F5'){?> (Fellowship 50%)<?php }?>
                                             <?php if ($_smarty_tpl->tpl_vars['jalur']->value=='F7'){?> (Fellowship 75%)<?php }?>
                                             <?php if ($_smarty_tpl->tpl_vars['alumni']->value==1){?>  (Alumni),<?php }?>
                                             <?php if ($_smarty_tpl->tpl_vars['transPaid']->value->keluargacivitas==1){?>  (Potongan Uang Masuk),<?php }?>
                                             <?php if ($_smarty_tpl->tpl_vars['transPaid']->value->keluargadlb==1){?>  (Potongan Uang Masuk),<?php }?>
                                             <?php if ($_smarty_tpl->tpl_vars['transPaid']->value->earlybirdS2==1){?>  (Potongan Uang Masuk - Gel 1),<?php }?>
                                             <?php if ($_smarty_tpl->tpl_vars['transPaid']->value->miaiPindahan==1){?> (Potongan MIAI)<br><?php }?>
